...
import { Heart, List, SparklesOutline, StarOutline, VideocamOutline } from '@vicons/ionicons5';
...
<template>
  ...
  >
    ...
    <n-back-top :bottom="220" :right="mainStore.backTopLeft" :visibility-height="800">
