    ...
    <div class='flex z-30 relative items-center p-2 footer-player'>
        ...
        <div :style="{opacity:isShow ? '1' : '0.6'}" class="flex flex-col flex-1 items-center control">
            ...
            <div class="flex justify-between items-center" style="width:300px">
                ...
                />
                <div class="flex justify-center items-center w-8 h-8  bg-neutral-200/60 hover:bg-neutral-200 dark:bg-slate-100/20 dark:hover:bg-slate-100/40 rounded-full"
                     @click="togglePlayStatus">
                    <n-icon :component="mainStore.playing ? StopIcon :PlayArrowSharp"
