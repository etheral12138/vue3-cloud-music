...
<template>
  <div ref="scrollContainerRef" class="relative mt-10 scrollContainer">
    <n-scrollbar
      ref="scrollBarRef" :on-scroll="handleScroll"
      style="height: 350px;width:550px" @wheel="handleWheel"
    >
      ...
      <div v-if="!mainStore.currentPlaySong?.isNotLyric" ref="lyricContainer">
        <div
          ...
          :data-time="item.time" class="text-center lyric-item"
        >
    ...
    <div v-show="showSelectLyric" class="selectLyricContainer">
      <div class="flex items-center">
        <n-time v-if="selectLyricLine" :time="selectLyricLine.time * 1000" format="mm:ss" />
